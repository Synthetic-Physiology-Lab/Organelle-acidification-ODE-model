...
def main():
    ...
    ODEMODELOBJ.GetPlot(SOL.t, pH, color="darkorange", label="pH - Python", xlabel="Time [s]", ylabel="pH", figname="validation_default_case")
    ...
    ## get flow plots
    ODEMODELOBJ.GetPlotF(SOL.t, Hflow, color="darkorange", label="Hflow", xlabel="Time [s]", ylabel="Hflow", figname="Hflow")
    ODEMODELOBJ.GetPlotF(SOL.t, Clflow, color="darkorange", label="Clflow", xlabel="Time [s]", ylabel="Clflow", figname="Clflow")
    ODEMODELOBJ.GetPlotF(SOL.t, Kflow, color="darkorange", label="Kflow", xlabel="Time [s]", ylabel="Kflow", figname="Kflow")
    ODEMODELOBJ.GetPlotF(SOL.t, Naflow, color="darkorange", label="Naflow", xlabel="Time [s]", ylabel="Naflow", figname="Naflow")
